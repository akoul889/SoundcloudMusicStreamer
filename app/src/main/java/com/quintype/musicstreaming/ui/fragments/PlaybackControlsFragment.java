...
import com.quintype.musicstreaming.utils.AlbumArtCache;
...
public class PlaybackControlsFragment extends Fragment {
    ...
    private final MediaControllerCompat.Callback mCallback = new MediaControllerCompat.Callback() {
        ...
        public void onPlaybackStateChanged(@NonNull PlaybackStateCompat state) {
            Timber.d("Received playback state change to state ", state.getState());
        ...
        public void onMetadataChanged(MediaMetadataCompat metadata) {
            ...
            Timber.d("Received metadata state change to mediaId=",
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.layout_playback_controls, container, false);
...
//                startActivity(intent);
    ...
    public void onConnected() {
        MediaControllerCompat controller = ((FragmentActivity) getActivity())
                .getSupportMediaController();
        Timber.d("onConnected, mediaController==null? ", controller == null);
        if (controller != null) {
            ...
            if (art != null) {
                ...
                cache.fetch(artUrl, new AlbumArtCache.FetchListener() {
                            ...
                            public void onFetched(String artUrl, Bitmap bitmap, Bitmap icon) {
                                if (icon != null) {
                                    Timber.d("album art icon of w=", icon.getWidth(),
                                            " h=", icon.getHeight());
                                    if (isAdded()) {
    ...
    private void onPlaybackStateChanged(PlaybackStateCompat state) {
        ...
        switch (state.getState()) {
            ...
            case PlaybackStateCompat.STATE_ERROR:
                Timber.e("error playbackstate: ", state.getErrorMessage());
